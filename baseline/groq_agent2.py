...
Uses Groq API (llama-3.1-8b-instant) to generate task-specific actions for email processing.
...
def run_agent(task: Literal["easy", "medium", "hard"] = "easy", max_steps: int = 5):
    ...
    print(f"\n{'='*60}")
    print(f"OpenEnv Baseline Agent - Task: {task.upper()} (Groq llama-3.1-8b)")
    print(f"{'='*60}\n")
