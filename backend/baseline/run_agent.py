...
Uses OpenAI API to generate task-specific actions for email processing.
...
def generate_action(client: OpenAI, observation, task: str) -> dict:
    """Generate an action using OpenAI API. Returns action or empty default."""
